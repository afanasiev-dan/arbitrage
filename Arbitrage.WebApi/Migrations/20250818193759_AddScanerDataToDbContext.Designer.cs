...
namespace Arbitrage.WebApi.Migrations
{
    ...
    [Migration("20250818193759_AddScanerDataToDbContext")]
    partial class AddScanerDataToDbContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Arbitrage.Scaner.Domain.Entities.ScanerModel", b =>
                {
                    ...
                    b.HasOne("Arbitrage.Symbols.Domain.Entities.Coin", "QouteCoin")
                        .WithMany()
                        .HasForeignKey("QouteCoinId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
